...
if __name__ == "__main__":
    # initialise the data
    spam_dir = 'decks/spamfilter/spam_sample/'
    spam = init_lists(spam_dir)
    ham_dir = 'decks/spamfilter/ham_sample/'
    ham = init_lists(ham_dir)
    ...
    # train the classifier
    train_set, test_set, classifier = train(all_features, 0.85)
...
pickle.dump(classifier, out_test)
