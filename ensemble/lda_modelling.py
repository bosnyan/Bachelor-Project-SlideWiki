...
for i in glob.glob("decks/ham_ensemble/*.txt"):
#for i in glob.glob("decks/ham_ensemble_filtered/*.txt"):
...
lda = LatentDirichletAllocation(n_components=NO_TOPICS, max_iter=MAX_ITER, evaluate_every=1, learning_method='online', learning_offset=10, batch_size=1024, random_state=0).fit(tf)
